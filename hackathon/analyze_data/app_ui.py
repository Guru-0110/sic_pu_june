...
def show_analysis_options():
    ...
    tk.Button(root, text="Sweet Sales vs. Month", bg='#d4af37', fg='black', font=font_style, command=select_sweet).pack(pady=10, ipadx=10, ipady=5)
    ...
    tk.Button(root, text="Least Sold Sweet vs. Month", bg='#d4af37', fg='black', font=font_style, command=select_month_least_sold).pack(pady=10, ipadx=10, ipady=5)
    tk.Button(root, text="Top Selling Sweet vs. Month", bg='#d4af37', fg='black', font=font_style, command=select_month_top_sold).pack(pady=10, ipadx=10, ipady=5)
    ...
    tk.Button(root, text="Sales Prediction (Prophet Forecast)", bg='#d4af37', fg='black', font=font_style, command=sales_prediction).pack(pady=10, ipadx=10, ipady=5)
